...
<section className="hero hero-light">
  ...
  <section>
    ...
    <Link to="/about#about-leadership" className="btn btn-outline">Meet Our Leadership</Link>
  </section>
  ...
  <section className="ctaband"><span className="glow"></span><span className="grid-ovl"></span><div className="inner reveal">
    ...
    <div className="ctas"><Link to="/contact" className="btn btn-yellow">Get Started</Link><Link to="/programs" className="btn btn-ghost">Explore Programs</Link></div>
  </div></section>
    </>
  );
}
