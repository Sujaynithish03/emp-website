...
<section className="pagehead">
    ...
    <div className="inner">
      <div className="txt">
        ...
        <div className="ctas"><Link to="/solutions" className="btn btn-yellow">Find Your Pathway</Link><Link to="/programs" className="btn btn-ghost">Explore Programs</Link></div>
      </div>
  ...
  <section className="ctaband"><span className="glow"></span><span className="grid-ovl"></span><div className="inner reveal">
    ...
    <div className="ctas"><Link to="/contact" className="btn btn-yellow">Get Started</Link><Link to="/solutions" className="btn btn-ghost">See Solutions</Link></div>
  </div></section>
    </>
  );
}
