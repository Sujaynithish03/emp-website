...
<section className="pagehead">
  ...
  <section className="ctaband"><span className="glow"></span><span className="grid-ovl"></span><div className="inner reveal">
    ...
    <div className="ctas"><Link to="/contact" className="btn btn-yellow">Get Started</Link><Link to="/career-paths" className="btn btn-ghost">See Career Paths</Link></div>
  </div></section>
    </>
  );
}
