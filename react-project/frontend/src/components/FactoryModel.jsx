import handshake from '../assets/hero-handshake-main-v3.webp';
...
export default function FactoryModel() {
  return (
    ...
    >
      ...
      {/* Human + AI handshake — the outcome the whole journey builds toward */}
      <div className="w-full flex justify-center mt-[40px] lg:mt-[120px]">

      </div>

      {/* Process chain at bottom */}
      <div className="w-full text-center mt-[20px] lg:mt-[30px] border-t border-white/10 pt-[30px]">
